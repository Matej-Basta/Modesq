    ...
    return (
        <div className="about">
            <div className="about__image">
                <img className="about__image__image" src="/img/slide-1.jpg" alt="betonový interiér" />
            </div>
            
            <div className="about__texts">
                <div className="about__texts__text">
                    <h3 className="about__texts__text__heading">Blok o produktech,<br/>materiálu a službách.</h3>
                ...
                <div className="about__texts__text">
                    <h3 className="about__texts__text__heading">Blok o projektech,<br/>spolupráci a službách.</h3>
